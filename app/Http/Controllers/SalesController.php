...
class SalesController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        \DB::transaction(function () use ($request) {
            ...
            $order->client_id = $request->client_id['value'];
            ...
            if ($request->payment['status'] != 'pending') {
                ...
                try {
                    ...
                    return response()->json(['message' => 'some information'], 500);
    ...
    // PO_Change_to_Sale
    public function Elemens_Change_To_Sale_PO(Request $request, $id)
    {
        ...
        if ($Quotation->location_id) {
            if (Location::where('id', $Quotation->location_id)
                ...
                $sale['warehouse_id'] = $Quotation->location_id;
            } else {
                $sale['warehouse_id'] = '';
            }
        } else {
