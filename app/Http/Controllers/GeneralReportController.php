...
class GeneralReportController extends Controller
{
    public function productReport($id)
    {
        ...
        $purchase_details = PurchaseDetail::with(['purchase', 'product'])->where('product_id', $id)->get();
        $purchases = [];
        ...
        $sales_details = SaleDetail::with(['sale'])->where('product_id', $id)->get();
        $sales = [];
        ...
        // transers reports
        $transfers_details = TransferDetail::with(['transfer', 'product'])->where('product_id', $id)->get();
        ...
        // adjustments reports
        $adjustments_details = AdjustmentDetail::with(['adjustment', 'product'])->where('product_id', $id)->get();
