...
Route::middleware(['auth:api', 'Is_Active'])->group(function () {
    ...
    Route::get("report/Adjustments_Warehouse", "ReportController@Adjustments_Warehouse");
    Route::get("report/Transfers_Warehouse", "ReportController@Transfers_Warehouse");
    ...
    Route::get("report/product/{id}", "GeneralReportController@productReport");
    // Route::get("report/product/{warehoue_id}/{id}", "GeneralReportController@productReport");
    ...
    Route::get('Products/Warehouse/NoVarient/{id}', 'ProductsController@Products_by_Warehouse_No_Varient');
    Route::get('Products/Location/{id}', 'ProductsController@Products_by_Location');
    ...
    Route::get('Get_Locations/All', 'LocationController@Get_Locations');
    Route::post('locations/delete/by_selection', 'LocationController@delete_by_selection');

    //------------------------------- PURCHASES --------------------------\\
    //------------------------------------------------------------------\\

    Route::resource('purchases', 'PurchasesController');
    Route::post('purchases/ledgers', 'PurchasesController@Get_Ledgers');
    ...
    Route::post('payment/purchase/selection', 'PaymentPurchasesController@paymentBySelection');
    ...
    Route::get('sales/Change_to_Sale_PO/{id}', 'SalesController@Elemens_Change_To_Sale_PO');
    ...
    //----------------------------- Purchase Order --------------------------\\
    //------------------------------------------------------------------\\
    Route::resource('prchaseorders', 'PurchaseOrderController');
    Route::post('prchaseorders/sendQuote/email', 'PurchaseOrderController@SendEmail');
    Route::post('prchaseorders/send/sms', 'PurchaseOrderController@Send_SMS');
    Route::get('prchaseorders/export/Excel', 'PurchaseOrderController@exportExcel');
    Route::post('prchaseorders/delete/by_selection', 'PurchaseOrderController@delete_by_selection');
    ...
    Route::get('Transfer_PDF/{id}', 'TransferController@PrintDS');
...
Route::get('PO_PDF/{id}', 'PurchaseOrderController@Quotation_pdf');
