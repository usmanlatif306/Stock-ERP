    ...
    <div class="main-content">
        ...
        >
            <div class="px-3 py-2">
                <b-row>
                    ...
                    <!-- From warehouse  -->
                    <b-col md="12">
                        <b-form-group :label="$t('From Warehouse/Location')">
                            <v-select
                    ...
                    <!-- To warehouse  -->
                    <b-col md="12">
                        <b-form-group :label="$t('To Warehouse/Location')">
                            <v-select
                                :reduce="(label) => label.value"
                                :placeholder="$t('Choose_Warehouse')"
                                v-model="Filter_To"
        ...
        >
                ...
                <b-col lg="5" md="12" sm="12" class="mt-3">
                    <table class="table table-hover table-bordered table-sm">
                        <tbody>
                            ...
                            <!-- From warehouse -->
                            <tr>
                                <td>{{ $t("From Warehouse/Location") }}</td>
                                <th>{{ transfer.from_warehouse }}</th>
                            </tr>
                            <!-- To warehouse -->
                            <tr>
                                <td>{{ $t("To Warehouse/Location") }}</td>
                ...
                <b-col lg="7" md="12" sm="12" class="mt-3">
                    <div class="table-responsive">
                        ...
                        >
                            ...
                            <tbody>
                                <tr v-for="(detail, idx) in details" :key="idx">
                                    <td>{{ detail.name }}</td>
                                    <td>{{ detail.code }}</td>
                                    <td>
            ...
            <template #modal-footer>
                <b-button variant="primary" @click="PrintDs(transfer.id)"
                    >Print DS</b-button
                >
            </template>
        </b-modal>
    ...
    computed: {
        ...
        columns() {
            return [
                ...
                {
                    label: this.$t("From Warehouse/Location"),
                    field: "from_warehouse",
                    tdClass: "text-left",
                    thClass: "text-left",
                },
                {
                    label: this.$t("To Warehouse/Location"),
                    field: "to_warehouse",
                    tdClass: "text-left",
                    thClass: "text-left",
                },
