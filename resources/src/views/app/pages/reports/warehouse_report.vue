            ...
            <b-col md="12">
                ...
                >
                    ...
                    >
                        ...
                        <!-- Adjustment -->
                        <b-tab :title="$t('Adjustments')">
                            <vue-good-table
                                mode="remote"
                                :columns="columns_adjustments"
                                :totalRows="totalRows_adjustments"
                                :rows="adjustments"
                                @on-page-change="PageChangeAdjustments"
                                @on-per-page-change="onPerPageChangeAdjustments"
                        ...
                        <!-- Transfers -->
                        <b-tab :title="$t('Transfers')">
                            <vue-good-table
                                mode="remote"
                                :columns="columns_transfers"
                                :totalRows="totalRows_transfers"
                                :rows="transfers"
                                @on-page-change="PageChangeTransfers"
                                @on-per-page-change="onPerPageChangeTransfers"
                        ...
                        <b-tab :title="$t('PurchasesReturn')">
                            <vue-good-table
                                ...
                                @on-per-page-change="
                                    onPerPageChangeReturn_Purchase
                                "
                                :pagination-options="{
                                    enabled: true,
                                    mode: 'records',
...
export default {
    ...
    methods: {
        ...
        Get_Reports() {
            axios
                .get(
                    "report/Warehouse_Report?warehouse_id=" +
                        this.Filter_warehouse
                )
                .then((response) => {
        ...
        //----------- Adjustments Event Page Change  ---------\\
        PageChangeAdjustments({ currentPage }) {
        ...
        onPerPageChangeAdjustments({ currentPerPage }) {
        ...
        onSearch_Adjustments(value) {
            this.search_adjustment = value.searchTerm;
            this.Get_Adjustments(1);
        },
        //--------------------------- Get adjustment By warehouse -------------\\
        Get_Adjustments(page) {
            axios
                .get(
                    "report/Adjustments_Warehouse?page=" +
                        page +
                        "&limit=" +
        ...
        //----------- Transfers Event Page Change  ---------\\
        PageChangeTransfers({ currentPage }) {
        ...
        onPerPageChangeTransfers({ currentPerPage }) {
        ...
        onSearch_Transfers(value) {
            this.search_transfer = value.searchTerm;
            this.Get_Transfers(1);
        },
        //--------------------------- Get transfer By warehouse -------------\\
        Get_Transfers(page) {
            axios
                .get(
                    "report/Transfers_Warehouse?page=" +
                        page +
                        "&limit=" +
