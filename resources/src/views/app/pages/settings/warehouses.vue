...
export default {
    ...
    data() {
        return {
            ...
            type: 0,
            options: [
                { value: "0", text: "Warehouse" },
                { value: "1", text: "Location" },
            ],
        };
    },
    ...
    methods: {
        ...
        Edit_Warehouse(warehouse) {
            ...
            this.type = warehouse.type === "Warehouse" ? 0 : 1;
            this.editmode = true;
            this.$bvModal.show("New_Warehouse");
        },
