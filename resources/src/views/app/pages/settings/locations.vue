<template>
    <div class="main-content">
        <breadcumb :page="$t('Locations')" :folder="$t('Settings')" />
            ...
            >
                ...
                <template slot="table-row" slot-scope="props">
                    <span v-if="props.column.field == 'actions'">
                        <a
                            @click="Edit_Warehouse(props.row)"
                            title="Edit"
                            v-b-tooltip.hover
                        >
                        ...
                        <a
                            title="Delete"
                            v-b-tooltip.hover
                            @click="Remove_Warehouse(props.row.id)"
                        >
                    ...
                    <b-row>
                        ...
                        <b-col md="6">
                            ...
                            >
                                <b-form-group :label="$t('City')">
                                    <b-form-input
                                        :placeholder="$t('Enter Location City')"
                                        :state="
                                            getValidationState(
                                                validationContext
                                            )
                        ...
                        <b-col md="6">
                            <b-form-group :label="$t('Email')">
                                <b-form-input
                                    type="email"
                                    :placeholder="$t('Enter Location Email')"
                                    label="Email"
                        ...
                        <b-col md="6">
                            <b-form-group :label="$t('ZipCode')">
                                <b-form-input
                                    type="number"
                                    :placeholder="$t('Enter Location ZipCode')"
                                    label="ZipCode"
...
export default {
    ...
    methods: {
        ...
        Create_Warehouse() {
            ...
            axios
                ...
                .then((response) => {
                    ...
                    this.makeToast(
                        "success",
                        this.$t("Location Created Successfully"),
                        this.$t("Success")
                    );
                })
                .catch((error) => {
        ...
        Update_Warehouse() {
            this.SubmitProcessing = true;
            axios
                .put("locations/" + this.warehouse.id, {
                    name: this.warehouse.name,
                    mobile: this.warehouse.mobile,
                    email: this.warehouse.email,
                    zip: this.warehouse.zip,
                ...
                .then((response) => {
                    ...
                    this.makeToast(
                        "success",
                        this.$t("Location Updated Successfully"),
                        this.$t("Success")
                    );
                })
                .catch((error) => {
                    ...
                    axios
                        ...
                        .then(() => {
                            this.$swal(
                                ...
                                this.$t("Location Deleted Successfully"),
                                "success"
                            );
                ...
                if (result.value) {
                    ...
                    axios
                        ...
                        .then(() => {
                            this.$swal(
                                this.$t("Delete.Deleted"),
                                this.$t("Locations Deleted Successfully"),
                                "success"
                            );
