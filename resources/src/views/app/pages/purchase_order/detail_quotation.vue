<template>
    <div class="main-content">
        <breadcumb
            :page="$t('Purchase Order')"
            :folder="$t('Purchase Order List')"
        />
        <div
            v-if="isLoading"
                ...
                <b-col md="12" class="mb-5">
                    <router-link
                        v-if="
                            ...
                            currentUserPermissions.includes('Quotations_edit')
                        "
                        title="Edit"
                    ...
                    <button
                        v-if="
                            currentUserPermissions &&
                            currentUserPermissions.includes('Quotations_delete')
                        "
                        @click="Remove_Quote()"
                ...
                <div class="invoice-print">
                    <b-row class="justify-content-md-center">
                        <h4 class="font-weight-bold">
                            {{ $t("Detail Purchase Order") }} : {{ quote.Ref }}
                        </h4>
                    </b-row>
                    <hr />
                    <b-row class="mt-5">
        ...
        Quote_PDF() {
            ...
            axios
                ...
                .then((response) => {
                    ...
                    link.setAttribute(
                        "download",
                        "Purchase Order_" + this.quote.Ref + ".pdf"
                    );
