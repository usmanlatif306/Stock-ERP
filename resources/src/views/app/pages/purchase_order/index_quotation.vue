<template>
    <div class="main-content">
        <breadcumb
            :page="$t('Purchase Order List')"
            :folder="$t('Purchase Order')"
        />
                        ...
                        <div>
                            ...
                            >
                                ...
                                <b-dropdown-item
                                    ...
                                    "
                                    :to="
                                        '/app/purchase-orders/Create_sale/' +
                                        props.row.id
                                    "
                                >
                                    <i
                                ...
                                <b-dropdown-item
                                    title="PDF"
                                    @click="Quote_pdf(props.row, props.row.id)"
                                >
                                    <i
                                ...
                                <b-dropdown-item
                                    title="Email"
                                    @click="QuoteEmail(props.row, props.row.id)"
                                >
                                    <i
...
export default {
    ...
    methods: {
        ...
        Quotation_PDF() {
            ...
            pdf.text("Purchase Order List", 40, 25);
        ...
        SendEmail(id) {
            ...
            NProgress.set(0.1);
            axios
                .post("prchaseorders/sendQuote/email", {
                    id: id,
                    to: this.email.to,
        ...
        Remove_Quotation(id) {
            this.$swal({
                ...
                if (result.value) {
                    ...
                    NProgress.set(0.1);
                    axios
                        .delete("prchaseorders/" + id)
                        .then(() => {
                            this.$swal(
                                this.$t("Delete.Deleted"),
                                this.$t("Purchase Order Deleted Successfully"),
                                "success"
                            );
        ...
        delete_by_selected() {
            this.$swal({
                ...
                if (result.value) {
                    ...
                    NProgress.set(0.1);
                    axios
                        .post("prchaseorders/delete/by_selection", {
