...
export default {
    ...
    methods: {
        ...
        search() {
            ...
            if (
                this.quote.warehouse_id != "" &&
                this.quote.warehouse_id != null
            ) {
        ...
        Get_Products_By_Warehouse(id) {
            ...
            NProgress.set(0.1);
            axios
                .get("Products/Location/" + id + "?stock=" + 1)
                .then((response) => {
        ...
        Update_Quotation() {
            if (this.verifiedForm()) {
                ...
                axios
                    .put(`prchaseorders/${id}`, {
                        client_id: this.quote.client_id,
                        GrandTotal: this.GrandTotal,
                        location_id: this.quote.location_id,
                    ...
                    .then((response) => {
                        ...
                        this.makeToast(
                            "success",
                            this.$t("Purchase Order Updated Successfully"),
                            this.$t("Success")
                        );

                        this.SubmitProcessing = false;
                        this.$router.push({ name: "index_purchase_orders" });
                    })
                    .catch((error) => {
                        // Complete the animation of theprogress bar.
                        NProgress.done();
