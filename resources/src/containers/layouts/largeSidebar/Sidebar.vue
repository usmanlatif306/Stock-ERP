    ...
    >
        ...
        >
            <div>
                <ul class="navigation-left">
                    ...
                    (currentUserPermissions.includes('PostSale_view') ||
                    currentUserPermissions.includes('PostSale_add')) " -->
                    <!-- <li
                        @mouseenter="toggleSubMenu"
                        class="nav-item"
                        :class="{
                            active: selectedParentMenu == 'purchaseOrder',
                        }"
                        data-item="purchaseOrder"
                        :data-submenu="true"
                    >
                        <a class="nav-item-hold" href="#">
                            <i class="nav-icon i-Checkout-Basket"></i>
        ...
        >
            <div ref="sidebarChild">
                ...
                <!-- <ul
                    class="childNav d-none"
                    data-parent="purchaseOrder"
                    :class="{
                        'd-block': selectedParentMenu == 'purchaseOrder',
                    }"
                >
                    <li class="nav-item">
                        <router-link
                    ...
                    <li class="nav-item">
                        <router-link
                            tag="a"
                            class
                            to="/app/purchase-orders/list"
                        >
                            <i class="nav-icon i-Files"></i>
                            <span class="item-name">{{
                                $t("List Purchase Orders")
                            }}</span>
                        </router-link>
                    </li>
                </ul> -->
                ...
                >
                    ...
                    <li
                        ...
                        "
                    >
                        <router-link tag="a" class to="/app/purchases/ledger">
                            <i class="nav-icon i-Files"></i>
                            <span class="item-name">{{
                                $t("Ledger Purchase")
                            }}</span>
                ...
                >
                    ...
                    >
                        <router-link tag="a" class to="/app/settings/Locations">
                            <i class="nav-icon i-Clothing-Store"></i>
                            <span class="item-name">{{ $t("Locations") }}</span>
                        </router-link>
                    </li> -->
                    <li
                        class="nav-item"
                ...
                >
                    ...
                    >
                        <router-link
                            tag="a"
                            class
                            to="/app/reports/product_reports"
                        >
                            <i class="nav-icon i-Split-FourSquareWindow"></i>
                            <span class="item-name">{{
                                $t("Product Reports")
