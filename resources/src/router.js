...
const routes = [
    {
        ...
        children: [
            ...
            //Purchase Orders
            {
                ...
                component: () =>
                    import(
                        /* webpackChunkName: "quotations" */ "./views/app/pages/purchase_order"
                    ),
                redirect: "/app/purchase-orders/list",
                children: [
                    {
                        name: "index_purchase_orders",
                        path: "list",
                        component: () =>
                            import(
                                "./views/app/pages/purchase_order/index_quotation"
                            ),
                    },
                    {
                        name: "store_purchase_orders",
                        path: "store",
                        component: () =>
                            import(
                                /* webpackChunkName: "store_quotation" */
                                "./views/app/pages/purchase_order/create_quotation"
                            ),
                    },
                    {
                        ...
                        component: () =>
                            import(
                                /* webpackChunkName: "edit_quotation" */
                                "./views/app/pages/purchase_order/edit_quotation"
                            ),
                    },
                    {
                        name: "detail_purchase_orders",
                        path: "detail/:id",
                        component: () =>
                            import(
                                /* webpackChunkName: "detail_quotation" */
                                "./views/app/pages/purchase_order/detail_quotation"
                            ),
                    },
                    {
                        name: "purchase_orders_to_sale",
                        path: "add-to-sale/:id",
                        component: () =>
                            import(
                                "./views/app/pages/purchase_order/change_to_sale"
                            ),
                    },
                ],
            },
            ...
            //Purchase
            {
                ...
                children: [
                    ...
                    {
                        name: "ledger_purchase",
                        path: "ledger",
                        component: () =>
                            import(
                                /* webpackChunkName: "detail_purchase" */
                                "./views/app/pages/purchases/ledger_purchase"
                            ),
                    },
                ],
            },
            ...
            // Settings
            {
                ...
                children: [
                    ...
                    // Locations
                    {
                        ...
                        component: () =>
                            import(
                                /* webpackChunkName: "Warehouses" */ "./views/app/pages/settings/locations"
                            ),
                    },
            ...
            // Reports
            {
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        component: () =>
                            /* webpackChunkName: "product_reports" */
                            import("./views/app/pages/reports/product_report"),
                    },
                    {
                        name: "payments_sales",
                        path: "payments_sale",
